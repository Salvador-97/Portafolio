    ...
    return (
        <>
            <div className={clsx(
                ...
                <a href="#" className='flex mx-[1.5rem] mt-[1rem]'>
                    <div className={clsx(
                ...
                <div className='mx-[1.5rem] mb-[1.5rem] flex justify-between'>
                    ...
                    <div className='w-[50%] flex flex-col items-center justify-between'>
                        <a href="#" 
                        className={clsx(
                            'w-full rounded-[1rem] border border-rosa transition-all duration-300 hover:bg-rosa  text-blanco text-center p-[0.4rem] font-bold'
                        )}>
                            Demo
                            <i className="fa-solid fa-arrow-up-right-from-square ml-[0.5rem]"></i>
                        </a>
                        <a href="#" className={clsx(
                            'w-full flex items-center justify-around rounded-[1rem] border border-rosa transition-all duration-300  hover:bg-rosa text-blanco text-center p-[0.4rem] font-bold'
                        )}>
